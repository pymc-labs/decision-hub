...
from dhub.cli.api_client import optional_client
...
def ask_command(
    ...
    with console.status("Searching registry..."), optional_client() as api:
        resp = api.get("/v1/ask", params=params, check=False)
