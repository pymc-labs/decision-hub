...
def ask_command(
    ...
    """
    # Local import: keeps existing test patches at
    # ``dhub.cli.config.get_optional_token`` / ``get_api_url`` working
    # without touching test_search_cli.py.
    from dhub.cli.config import api_client, get_optional_token, raise_for_status
