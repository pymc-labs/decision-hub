...
**Security prompts** — The gauntlet and search guard use LLM prompts loaded from `server/src/decision_hub/infra/security_prompts.yaml`. This file is not committed to the repository. For development and testing, copy the example file:
