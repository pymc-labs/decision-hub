...
# Explicit timeout for every GitHub API call.  httpx's implicit 5s default
# would be enforced anyway, but stating it here keeps the budget visible
# alongside the request and protects against accidental long polls if the
