...
# Rate-limit both device-flow endpoints via the shared factory.
_enforce_auth_rate_limit = rate_limit_dependency(
    "_auth_rate_limiter",
    lambda s: (s.auth_rate_limit, s.auth_rate_window),
)
