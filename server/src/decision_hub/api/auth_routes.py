...
@router.post("/github/code", response_model=DeviceCodeResponseSchema, dependencies=[limit("auth")])
...
@router.post("/github/token", response_model=TokenResponse, dependencies=[limit("auth")])
