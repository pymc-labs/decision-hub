...
# Per-IP sliding window for the device-flow endpoints (start + token exchange).
_enforce_auth_rate_limit = rate_limit_dependency("auth", "auth_rate_limit", "auth_rate_window")
