...
@router.post("/github/code", response_model=DeviceCodeResponseSchema, dependencies=[rate_limit("auth")])
...
@router.post("/github/token", response_model=TokenResponse, dependencies=[rate_limit("auth")])
