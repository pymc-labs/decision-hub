...
@router.post("/github/code", response_model=DeviceCodeResponseSchema, dependencies=[Depends(rate_limit("auth"))])
...
@router.post("/github/token", response_model=TokenResponse, dependencies=[Depends(rate_limit("auth"))])
