...
# Shared rate-limit dependencies — each name maps to
# settings.<name>_rate_limit / settings.<name>_rate_window.  See
# ``rate_limit_dep`` for the lazy-init behaviour.
_rl_list_skills = rate_limit_dep("list_skills")
_rl_resolve = rate_limit_dep("resolve")
_rl_similar_skills = rate_limit_dep("similar_skills")
_rl_download = rate_limit_dep("download")
_rl_audit_log = rate_limit_dep("audit_log")
_rl_scan_report = rate_limit_dep("scan_report")
_rl_publish = rate_limit_dep("publish")


_VALID_VISIBILITIES = {"public", "org"}


# Backwards-compatible alias so existing call sites still work.
