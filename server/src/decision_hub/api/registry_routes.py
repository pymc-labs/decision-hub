...
from decision_hub.api.rate_limit import enforce_rate_limit
...
# Per-endpoint rate limiters. Each entry generates a FastAPI dependency that
# lazily creates a sliding-window limiter from the matching settings fields.
_enforce_list_skills_rate_limit = enforce_rate_limit("list_skills", "list_skills_rate_limit", "list_skills_rate_window")
_enforce_resolve_rate_limit = enforce_rate_limit("resolve", "resolve_rate_limit", "resolve_rate_window")
_enforce_similar_skills_rate_limit = enforce_rate_limit(
    "similar_skills", "similar_skills_rate_limit", "similar_skills_rate_window"
)
_enforce_download_rate_limit = enforce_rate_limit("download", "download_rate_limit", "download_rate_window")
_enforce_audit_log_rate_limit = enforce_rate_limit("audit_log", "audit_log_rate_limit", "audit_log_rate_window")
_enforce_scan_report_rate_limit = enforce_rate_limit("scan_report", "scan_report_rate_limit", "scan_report_rate_window")
_enforce_publish_rate_limit = enforce_rate_limit("publish", "publish_rate_limit", "publish_rate_window")
