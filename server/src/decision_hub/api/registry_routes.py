...
# Rate-limit dependencies for every public registry endpoint.
# Each name must match a pair of settings: ``<name>_rate_limit`` /
# ``<name>_rate_window`` (see ``decision_hub.settings.Settings``).
