...
@router.post("/publish", response_model=PublishResponse, status_code=201, dependencies=[rate_limit("publish")])
def publish_skill(
    metadata: str = Form(...),
...
@public_router.get(
    ...
    dependencies=[rate_limit("list_skills")],
)
def list_skills(
...
@public_router.get(
    ...
    # Reuse the list-skills budget: fetching a summary is equivalent in cost
    # and attack surface to paging through the list endpoint.
    dependencies=[rate_limit("list_skills")],
)
...
@public_router.get(
    ...
    dependencies=[rate_limit("similar_skills")],
)
...
@public_router.get(
    ...
    dependencies=[rate_limit("resolve")],
)
def resolve_skill(
    org_slug: str,
    skill_name: str,
...
@public_router.get(
    ...
    dependencies=[rate_limit("audit_log")],
)
def get_audit_log(
    org_slug: str,
    skill_name: str,
...
@public_router.get(
    ...
    dependencies=[rate_limit("scan_report")],
)
def get_scan_report(
    org_slug: str,
    skill_name: str,
