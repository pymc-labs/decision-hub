...
# Rate-limit dependencies for each endpoint.  All limiters are
# constructed at app startup in ``create_app`` (see api/rate_limit.py)
# so concurrent first-requests cannot race-create competing instances.
_enforce_list_skills_rate_limit = rate_limit("list_skills")
_enforce_resolve_rate_limit = rate_limit("resolve")
_enforce_similar_skills_rate_limit = rate_limit("similar_skills")
_enforce_download_rate_limit = rate_limit("download")
_enforce_audit_log_rate_limit = rate_limit("audit_log")
_enforce_scan_report_rate_limit = rate_limit("scan_report")
_enforce_publish_rate_limit = rate_limit("publish")
