...
# Per-endpoint rate-limit dependencies. Each lazily binds to its
# ``settings.{name}_rate_{limit,window}`` pair on first request and
# caches a single RateLimiter on app.state — see make_rate_limit_dep.
