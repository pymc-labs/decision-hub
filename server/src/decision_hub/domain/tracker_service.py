    ...
    *,
    ...
    try:
        ...
        try:
            ...
            # Surface ANY publish error to operators — previously partial
            # failures (some skills published, some failed) silently cleared
            # last_error because only fully-failed batches set it.
