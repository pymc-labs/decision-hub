...
class TestBatchFetchCommitShas:
    ...
    def test_single_repo(self):
        ...
        sha_map, failed_keys, stars, _repo_meta = batch_fetch_commit_shas(client, [("owner", "repo", "main")])
    ...
    def test_missing_repo_omitted(self):
        ...
        sha_map, failed_keys, stars, _repo_meta = batch_fetch_commit_shas(
            client,
    ...
    def test_empty_ref_omitted(self):
        ...
        sha_map, failed_keys, stars, _repo_meta = batch_fetch_commit_shas(client, [("owner", "empty", "main")])
        assert sha_map == {}
        assert failed_keys == set()
