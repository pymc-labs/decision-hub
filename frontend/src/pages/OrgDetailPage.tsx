  ...
  if (isOrgNotFound) {
    ...
    return (
      <div className="container" style={{ textAlign: "center", paddingTop: "4rem" }}>
        {is404 ? (
          <>
            <p style={{ fontSize: "var(--text-hero)", fontWeight: 800, color: "var(--color-primary)", margin: 0, letterSpacing: "-0.04em" }}>404</p>
          ...
          <>
            <p style={{ fontSize: "var(--text-hero)", fontWeight: 800, color: "var(--color-error)", margin: 0, letterSpacing: "-0.04em" }}>Error</p>
